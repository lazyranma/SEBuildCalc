...
$(FACILITY_JSON) $(SPACECRAFT_JSON) $(LAUNCH_VEHICLE_JSON) $(LOCALES_JSON) $(BUILDABILITY_JSON) $(RESEARCH_JSON):
	@echo "ERROR: Game data files not found in $(DATA_DIR)/." >&2
	@echo "Run 'make extract-run' first." >&2
	@exit 1

# --- HTML table ---
$(HTML_OUT): generate_table.py $(FACILITY_JSON) $(SPACECRAFT_JSON) $(LAUNCH_VEHICLE_JSON) $(ICONS_STAMP) $(LOCALES_JSON) $(BUILDABILITY_JSON) $(RESEARCH_JSON)
